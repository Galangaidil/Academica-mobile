...
public class EditCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (courseRVModal != null) {
            ...
            courseImageLinkEdt.setText(courseRVModal.getCourseImageLink());
        ...
        updateCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                map.put("courseImageLink", courseImageLink);
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditCourseActivity.this, "Fail to update the course", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
